package Hospital.frontend.presentation.prescribir.buscarMedicamento;
    ...
    public View() {
        ...
        okButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Hospital.frontend.presentation.prescribir.buscarMedicamento.crearPrescripcion.
                        View crearPrescripcionView = null;
                if (medicamentoBusquedaTable.getSelectedRow() >=0) {
                    crearPrescripcionView = new Hospital.frontend.presentation.prescribir.buscarMedicamento.
