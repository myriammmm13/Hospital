...
public class View implements PropertyChangeListener {
    ...
    private Hospital.frontend.presentation.despacho.detalleMed.View detalleMedView;
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    if (filaVista != -1) {
                        ...
                        detalleMedView = new Hospital.frontend.presentation.despacho.detalleMed.View(recetaSeleccionada);
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        switch (evt.getPropertyName()) {
            ...
            case Model.RECETASRECIENTES:
                ...
                break;
            case Hospital.frontend.presentation.prescribir.Model.CURRENT:
