...
public class View implements PropertyChangeListener {
    ...
    private presentation.despacho.detalleMed.View detalleMedView;
    ...
    public View(){
        ...
        detallesPrescripcionButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                detalleMedView = new presentation.despacho.detalleMed.View(model.getRecetasList().get(getFilaModeloSeleccionada()));
