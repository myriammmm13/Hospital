    ...
    public View() {
        ...
        okButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                presentation.prescribir.buscarMedicamento.crearPrescripcion.View crearPrescripcionView = null;
                if (medicamentoBusquedaTable.getSelectedRow() >=0) {
                    crearPrescripcionView = new presentation.prescribir.buscarMedicamento.crearPrescripcion.View(controller.getMedicamento(medicamentoBusquedaTable.getSelectedRow()));
                }
